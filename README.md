# Movie Recommender System using Google Cloud 
...
<p> In this project, we have implemented the system with Tensor Flow and Cloud Machine Learning in GCP. We have used Weighted Least Square Algorithm included in contrib.factorization package of Tensor Flow code base. The implementation is carried out in 4 steps.
</p>
<ul>
   <li>Create a model</li>
</ul>
<ul>
   <li>Train and Tune on Cloud</li>
</ul>
<ul>
   <li>Apply to Data from Google Analytics</li>
</ul>
<ul>
   <li>Deploy Production System on GCP.</li>
</ul>
